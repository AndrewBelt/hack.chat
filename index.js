...
module.exports = function () {
	...
	spawn.sync('make', ['clean', '--directory=client'], { stdio: 'ignore' })
	spawn.sync('make', ['--directory=client'], { stdio: 'ignore' })
	...
	spawn('./node_modules/.bin/http-server', ['client/', '-o'], { stdio: 'inherit' })
